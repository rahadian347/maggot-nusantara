            ...
            <Accordion className="accodion-style--1" preExpanded={'0'}>
                <AccordionItem>
                    ...
                    <div className="course__curriculum-info">
                        ...
                        <span className="time"> <i><FontAwesomeIcon icon={['fas', 'clock']} /></i> 14 minutes</span>
                    ...
                    <div className="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                        ...
                        <div className="course__curriculum-meta">
                        <span className="time"> <i><FontAwesomeIcon icon={['fas', 'clock']} /></i> 15 minutes</span>
                        </div>
                    </div>
                    <div className="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                        <div className="course__curriculum-info">
                        ...
                        <div className="course__curriculum-meta">
                        <span className="time"> <i><FontAwesomeIcon icon={['fas', 'clock']} /></i> 7 minutes</span>
                    ...
                    <div className="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                        ...
                        <div className="course__curriculum-meta">
                        <span className="time"> <i><FontAwesomeIcon icon={['fas', 'clock']} /></i> 22 minutes</span>
                        </div>
                    </div>
                    </AccordionItemPanel>
                </AccordionItem>
