        ...
        <div className="cartmini__area">
         <div className="cartmini__wrapper">
            ...
            <div className="cartmini__close">
               <button type="button" className="cartmini__close-btn" onClick={() => setShopOpen(false)}><i><FontAwesomeIcon icon={['fas', 'times']} /></i></button>
            </div>
               ...
               <div className="cartmini__inner">
                  <ul>
                     <li>
                        ...
                        <a href="#" className="cartmini__del"><i><FontAwesomeIcon icon={['fas', 'times']} /></i></a>
                     </li>
                     <li>
                        <div className="cartmini__thumb">
                           <a href="#">
