...
const HeaderSearch = ({setSearchOpen, searchOpen}) => {
      ...
      return (
        ...
        <div className="header__search-3" className={searchOpen ? "header__search-3 search-opened": "header__search-3"}>
                        ...
                        <div className="header__search-3-inner text-center">
                            <form action="#">
                                <div className="header__search-3-btn">
                                    <a href="#!" className="header__search-3-btn-close" onClick={() => setSearchOpen(false)}><i><FontAwesomeIcon icon={['fas', 'times']} /></i></a>
                                </div>
